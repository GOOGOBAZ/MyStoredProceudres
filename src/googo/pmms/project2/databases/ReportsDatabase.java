...
return level1m;
  ...
  public   Map<String, Object> getBalances(String Level5Items,String startDate, String endDate){
  ...
  level2m= new HashMap<>() ;
   ...
   Level5Items=Level5Items.replace("(", "&");
    ...
    masterAccount=masterAccountUnique(Level5Items);
  
    String startingBal=balancepAndLFstart(masterAccount,startDate);
...
return level2m;
    ...
    private String getPandLBalances(String startDate, String endDate,String Level5Items){
...
return bal;
  ...
  private String balancepAndLFstart(String masterAccount,String date){
...
private String  masterAccountUnique(String accountName){
...
return accountNumber;
  ...
  public   Map<String, Object> getBalancesSheet(String Level5Items,String sheetDate){
...
return level2m;
 ...
 private String getBalanceSheetBalances(String Level5Items,String sheetDate){
...
data1= new HashMap<>();	
   ...
   accountBalance=getBalanceSheetBalances(leve5Item,endDate);
   
   }else if(isPandLItem(leve5Item)){
   
   
   accountBalance=getPandLBalances(startDate,endDate,leve5Item);
...
return theItem; 
   ...
   private boolean isPandLItem(String Level5Items){
   String masterAccount="",master=""; boolean theItem=false;
...
data1= new HashMap<>();	
      ...
      try {
         ...
         String query = "SELECT total_instalments,total_loanAmount,instalment_start_date,princimpal_amount,instalment_next_due_date,total_interest,instalment_end_date,instalment_amount,remaining_instalments,balance_due FROM new_loan_appstore WHERE applicant_account_number="+accountNumber;
          PreparedStatement psxmt = cq.prepareStatement(query);
          ResultSet rsxmt = psxmt.executeQuery();
         ...
         if (rsxmt.last()){
                ...
                data1.put(1, parseDouble(df2.format(parseDouble(rsxmt.getObject("total_loanAmount").toString()))));    
...
data1= new HashMap<>();	
      ...
      try {
         ...
         String query = "SELECT total_instalments,total_loanAmount,instalment_start_date,princimpal_amount,instalment_next_due_date,total_interest,instalment_end_date,instalment_amount,remaining_instalments,balance_due FROM new_loan_appstore WHERE loan_id="+"'"+loanid+"'";
          PreparedStatement psxmt = cq.prepareStatement(query);
          ResultSet rsxmt = psxmt.executeQuery();
...
data1= new HashMap<>();
      ...
      try {
         ...
         cq.setAutoCommit(false);
          ...
          String query = "SELECT instalment_no,instalment_amount,InstalmentRemaining,instalment_paid,closing_bal,instalment_due_date,instalment_status,instalment_paid_date FROM new_loan_appstoreamort  WHERE master2_id="+"'"+"newloan"+accountNumber+"'";
        ...
        data2.add(0, rsxmt.getString("instalment_no"));
         ...
         data2.add(1, rsxmt.getString("instalment_amount"));
          ...
          data2.add(2, rsxmt.getString("InstalmentRemaining"));
          
          data2 .add(3, rsxmt.getString("instalment_paid"));
...
if(savingsExists(accountNumber,startDate,endDate)){
      ...
      try {
          ...
          String query = "SELECT SavingsMonth,SavingsYear,SavingsAdded,SavingsRemoved,SavingsRunningBalance FROM newsavingsmembers"+" "+"WHERE ((TrnDate>="+"'"+startDate+"'"+" "+"AND TrnDate<="+"'"+endDate+"'"+")"+" "+"AND"+" "+"(AccountNumber="+"'"+accountNumber+"'"+"))";
        ...
        data2.add(t);
        data2.add(rsxmt.getString("SavingsMonth")+" "+rsxmt.getString("SavingsYear"));
...
//if(indiSharesDailyExists(accountNumber,startDate,endDate)){
      ...
      try {
          ...
          String query = "SELECT TxnYear,AccountNmae,AccountNumber,LedgerBalance,InterestComputed FROM sharesinterestpaymentannually"+" "+"WHERE ((TrnDate>="+"'"+startDate+"'"+" "+"AND TrnDate<="+"'"+endDate+"'"+")"+" "+"AND"+" "+"(LedgerBalance>0))";
...
return data1;
  ...
  public synchronized  Map<Integer, List<Object>>savingsIndivROIGrouped(String startDate,String endDate,Component c){
     double totalRunningBal=0.0,totalReturn=0.0;
...
//if(indiSharesDailyExists(accountNumber,startDate,endDate)){
      ...
      try {
          ...
          String query = "SELECT TxnYear,AccountNmae,AccountNumber,LedgerBalance,InterestComputed FROM savingsinterestpaymentannually  WHERE ((TrnDate>="+"'"+startDate+"'"+" "+"AND TrnDate<="+"'"+endDate+"'"+")"+" "+"AND"+" "+"(LedgerBalance>0))";
...
try {
  ...
  public double getbActualTotal(String accountItem,String startDate,String endDate){
   ...
   accountItem=accountItem.replace("(", "&");
    ...
    masterAccount=masterAccountUnique(accountItem);
     double firstbal=parseDouble( balancepAndLFstart(masterAccount,startDate));
