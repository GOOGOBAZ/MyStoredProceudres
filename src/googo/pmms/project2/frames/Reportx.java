    ...
    BogaStatement boga = new BogaStatement();
     ...
     LoanSavingsSharesOthers loanSaveShare=new LoanSavingsSharesOthers();
        String userId;
         ...
         String theAccount="",theAccountcn="";
    /**
...
//}
    ...
    private void initComponents() {
        ...
        agingReport = new javax.swing.JPanel();
        ...
        performingLoanPortfolio = new javax.swing.JPanel();
        ...
        trialBalancePanel1.setBounds(30, 30, 70, 560);
        ...
        jButton18.setBounds(10, 140, 240, 30);
        ...
        jButton21.setBounds(10, 570, 240, 30);
        ...
        jButton22.setBounds(10, 200, 240, 30);

        jButton8.setForeground(new java.awt.Color(0, 153, 153));
        jButton8.setText("LOANS DUE FOR WRITE OFF");
        ...
        assetsButto2.setBounds(10, 320, 240, 30);
        ...
        cashFlowButton2.setBounds(10, 230, 240, 30);

        loanApprovedButton.setForeground(new java.awt.Color(0, 204, 153));
        loanApprovedButton.setText("LOANS APPROVED");
        ...
        loanApprovedButton.setBounds(10, 350, 240, 30);
        loanApprovedButton.setVisible(false);
        ...
        loanAppliedButton.setBounds(10, 170, 240, 30);
        ...
        loanPortFolioButton.setBounds(10, 290, 240, 30);
        ...
        jButton51.setBounds(10, 440, 240, 30);
        jButton51.setVisible(false);
        ...
        jButton52.setBounds(10, 570, 240, 30);
        ...
        jButton53.setBounds(10, 570, 240, 30);
        ...
        jButton54.setBounds(10, 570, 240, 30);
        ...
        jButton19.setBounds(10, 260, 240, 30);
        ...
        jButton73.setBounds(10, 110, 240, 30);

        bogaStatementButton.setForeground(new java.awt.Color(0, 153, 153));
        bogaStatementButton.setText("BOGA STATEMENT");
        ...
        bogaStatementButton.setBounds(10, 380, 240, 30);
        bogaStatementButton.setEnabled(false);
        bogaStatementButton.setVisible(false);
        ...
        jButton82.setBounds(10, 540, 240, 30);
        jButton82.setVisible(false);
        ...
        jButton83.setBounds(10, 600, 240, 30);
        jButton83.setVisible(false);
        ...
        loansInArrearsButton.setBounds(10, 510, 240, 30);
        loansInArrearsButton.setVisible(false);
        ...
        loansApprovedPanel.setBounds(30, 40, 850, 550);
        ...
        loansDue.setBounds(30, 40, 850, 550);
        ...
        loansInArrears.setBounds(30, 40, 850, 550);
        ...
        loansToStaffMembers.setBounds(30, 40, 850, 550);
        ...
        jButton128.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton128.setText("Create Loan Register");
        jButton128.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton128ActionPerformed(evt);
            }
        });
        jPanel20.add(jButton128);
        jButton128.setBounds(20, 20, 220, 50);

        jButton214.setText("EXCEL");
        jPanel20.add(jButton214);
        jButton214.setBounds(130, 100, 100, 50);

        jButton213.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton213.setText("PDF");
        jPanel20.add(jButton213);
        jButton213.setBounds(10, 100, 110, 50);

        summuryOnLoans.add(jPanel20);
        jPanel20.setBounds(610, 100, 70, 50);
        ...
        jButton211.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton211.setText("Create Quick Summury");
        jButton211.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton211ActionPerformed(evt);
            }
        });
        jPanel22.add(jButton211);
        jButton211.setBounds(30, 20, 220, 50);

        jButton210.setText("EXCEL");
        jPanel22.add(jButton210);
        jButton210.setBounds(150, 90, 100, 50);

        jButton212.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton212.setText("PDF");
        jPanel22.add(jButton212);
        jButton212.setBounds(30, 90, 110, 50);

        summuryOnLoans.add(jPanel22);
        jPanel22.setBounds(330, 120, 120, 30);
        ...
        summuryOnLoans.setBounds(30, 40, 850, 550);
        ...
        jButton50.setText("CREATE GABO STATEMENT");
        ...
        jButton50.setBounds(300, 230, 230, 40);

        loanReportsPanel.add(BOGAPanel);
        BOGAPanel.setBounds(30, 40, 850, 550);
        ...
        loansDisbursedPanel.setBounds(30, 40, 850, 550);
        ...
        loansDue1.setBounds(30, 40, 850, 550);
        loansDue1.setVisible(false);

        agingReport.setBackground(java.awt.SystemColor.activeCaption);
        agingReport.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        agingReport.setLayout(null);

        jButton74.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton74.setText("CREATE ARREARS REPORT");
        jButton74.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton74ActionPerformed(evt);
            }
        });
        agingReport.add(jButton74);
        jButton74.setBounds(140, 120, 250, 30);

        jButton106.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton106.setText("Export Excell");
        jButton106.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton106ActionPerformed(evt);
            }
        });
        agingReport.add(jButton106);
        jButton106.setBounds(390, 170, 156, 30);
        ...
        agingReport.add(jComboBox2);
        jComboBox2.setBounds(390, 120, 200, 30);

        jButton125.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton125.setText("Export Pdf");
        jButton125.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton125ActionPerformed(evt);
            }
        });
        agingReport.add(jButton125);
        jButton125.setBounds(230, 170, 156, 30);

        loanReportsPanel.add(agingReport);
        agingReport.setBounds(30, 40, 850, 550);
        agingReport .setVisible(false);
        agingReport.getAccessibleContext().setAccessibleName("");
        ...
        portfolioAtRisk.setBounds(30, 40, 850, 550);
        ...
        jButton105.setBounds(10, 90, 250, 30);

        loanPortFolioPanel.add(jPanel9);
        jPanel9.setBounds(420, 40, 270, 120);
        ...
        jButton308.setBounds(320, 240, 250, 30);

        loanReportsPanel.add(loanPortFolioPanel);
        loanPortFolioPanel.setBounds(30, 40, 850, 550);
        ...
        jButton63.setIcon(new javax.swing.ImageIcon(getClass().getResource("/googo/pmms/project2/images/submit2.png"))); // NOI18N
        jButton63.setText("CREATE LOANS DUE WRITEOFF");
        ...
        jButton63.setBounds(10, 90, 270, 40);
        ...
        jPanel12.setBounds(160, 180, 280, 140);

        loanReportsPanel.add(loansDueForWriteOff);
        loansDueForWriteOff.setBounds(30, 40, 850, 550);
        ...
        loansCompletedPanel.setBounds(30, 40, 850, 550);
        loansCompletedPanel.setVisible(false);

        performingLoanPortfolio.setBackground(java.awt.SystemColor.activeCaption);
        performingLoanPortfolio.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        performingLoanPortfolio.setLayout(null);

        jPanel7.setBackground(java.awt.SystemColor.activeCaption);
        jPanel7.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel7.setLayout(null);

        jButton65.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton65.setText("CREATE PERFORMING PORTFOLIO");
        ...
        jButton65.setBounds(10, 90, 250, 40);

        jLabel30.setText("START DATE");
        jLabel30.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel7.add(jLabel30);
        jLabel30.setBounds(10, 10, 90, 30);

        jLabel14.setText("END  DATE");
        jLabel14.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel7.add(jLabel14);
        jLabel14.setBounds(10, 50, 90, 30);
        jPanel7.add(jTextField8);
        jTextField8.setBounds(120, 10, 120, 30);
        jPanel7.add(jTextField10);
        jTextField10.setBounds(120, 50, 120, 30);
        ...
        jButton89.setBounds(240, 10, 20, 30);
        ...
        jButton87.setBounds(240, 50, 20, 30);

        performingLoanPortfolio.add(jPanel7);
        jPanel7.setBounds(310, 120, 270, 140);

        loanReportsPanel.add(performingLoanPortfolio);
        performingLoanPortfolio.setBounds(30, 40, 850, 550);
        ...
        jCheckBox2.setBounds(10, 10, 170, 23);
        ...
        jCheckBox3.setBounds(190, 10, 160, 23);
        ...
        loanStatementPanel.setBounds(30, 40, 850, 550);
        ...
        jPanel13.setBounds(20, 410, 30, 120);
        ...
        loansAppliedPanel.setBounds(30, 40, 850, 550);
        ...
        tablePanel.setBounds(30, 40, 850, 550);
        ...
        loanDisbursementSchedule.setBounds(30, 40, 850, 550);
        ...
        balanceSheetButton7.setBounds(10, 580, 240, 30);
        ...
        DailyCollections.setBounds(30, 40, 950, 540);
        ...
        jButton251.setText("Export Excel");
        ...
        jButton251.setBounds(310, 170, 110, 40);
        ...
        jButton267.setText("Export Excel");
        ...
        jButton267.setBounds(310, 210, 110, 40);
        ...
        summuryReportJPanel.setBounds(30, 40, 950, 30);
        summuryReportJPanel.setVisible(false);

        jPanel35.add(jPanel37);
        jPanel37.setBounds(280, 10, 990, 630);
...
if(col>=3&&col<=7){
       ...
       loan.updateInterestRepaymentsInterest(); 
         ...
         theOtherDetailsBalanceSheet.add(valueDate8.getText().trim());  
          TheBalanceSheet finPosPnL=new TheBalanceSheet(valueDate8.getText().trim());
            ...
            JOptionPane.showMessageDialog(this, "Wait!!! Wait!!....Balance sheet is beeing created!!!");
                ...
                return  finPosPnL.createBalanceSheet();
                }
...
//        }
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
       ...
       List balanceSheet=sheet.balanceSheetAggregator("",fmt.forDatabaseWithFullYearBeginningWithDate(valueDate8.getText().trim()));
 ...
 if (valueDate9.getText().equalsIgnoreCase("")||valueDate13.getText().equalsIgnoreCase("")) {
     ...
     if(pAndL.createPAndL(fmt.forDatabaseWithFullYearBeginningWithDate(valueDate9.getText().trim()),fmt.forDatabaseWithFullYearBeginningWithDate(valueDate13.getText().trim()),"pAndL")){
...
//        }
   ...
   loanPortFolioPanel.setVisible(false);
    ...
    private void jButton50ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50ActionPerformed
       ...
       if(boga.createBogaStatement("boga_Statement")){
     generateFile("boga_Statement"); 
        } else{
    ...
    private void JBTrnSqNo3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBTrnSqNo3ActionPerformed
        ...
        dbq.fillMeWithAllAccountsB(jTable1);
       ...
       fios.intFileWriterReplace(fios.createFileName("loanApplication", "amortValues", "loanArrearsWindow.txt"),x.toString());
          tablePanel.setVisible(true);
           ...
           dbq.fillMeWithAllAccountsBClosed(jTable1);
                 sortTable(jTable1,jTextField21); 
        loanStatementPanel.setVisible(false);
       Integer x=27;
       fios.intFileWriterReplace(fios.createFileName("loanApplication", "amortValues", "loanArrearsWindow.txt"),x.toString());
...
//        } 
  ...
  dbq.fillMeWithAllAccountsD(jTable1);
        sortTable(jTable1,jTextField21); 
        loansInArrears.setVisible(false);
...
//     if(writtenOff.createLoanWrittenOffReport("loan_writtenOff")){
//     generateFile("loan_writtenOff"); 
//        } else{
//        
//        JOptionPane.showMessageDialog(this, "First Close the Opened pdf File");
//       
//        } 
             if (jTextField8.getText().equalsIgnoreCase("")||jTextField10.getText().equalsIgnoreCase("")) {
        JOptionPane.showMessageDialog(this, "Please Select a valid date from the calender");
        return;
        }else if (fmt.convertTdate(jTextField8.getText().trim()).after(fmt.getTodayDate())||fmt.convertTdate(jTextField10.getText().trim()).after(fmt.getTodayDate())) {
         JOptionPane.showMessageDialog(this, "The selected date should not be greater than today");
         return;
        }
            
     if(otherLoans.createperformingPortfolio(fmt.forDatabaseWithFullYearBeginningWithDate(jTextField8.getText().trim()),fmt.forDatabaseWithFullYearBeginningWithDate(jTextField10.getText().trim()),"performing_portfolio")){
  
     generateFile("performing_portfolio"); 
        } else{
 ...
 fios.intFileWriterReplace(fios.createFileName("loanApplication", "amortValues", "loanStatements.txt"),"3");
   ...
   loanPortFolioPanel.setVisible(false);
    ...
    private void jButton74ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton74ActionPerformed
        ...
        if(jComboBox2.getSelectedItem().toString().equalsIgnoreCase("Select Portfolio Owner")){JOptionPane.showMessageDialog(this, "Please First Select The Portfolio Owner");return;}else{
      
            JOptionPane.showMessageDialog(this, "Wait while aging Report is beeing created!!!");
                SwingWorker<ListDataModel,Void>pAnLWorker=new SwingWorker() {
                @Override
                protected ListDataModel doInBackground() throws Exception {
                return  otherLoans.aginLoans();
                }
                ...
                agingAnalysis.add(result);
         ReportView f1 = new ReportView(userId,"AgingAnalysis",agingAnalysis);
        f1.setVisible(true);
        Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
        f1.setSize(screen.getSize());
        f1.pack();
...
//            jButton116.setEnabled(false);
 ...
 JOptionPane.showMessageDialog(this, netprofits.theNetProfits(fmt.forDatabaseWithFullYearBeginningWithDate(fios.stringFileReader(fios.createFileName("persistence", "operatingCycle", "YEARstartDate.txt")).trim()),fmt.forDatabaseWithFullYearBeginningWithDate(valueDate8.getText())));
...
//         returnOnInvestmentPanel
   ...
   Integer z2=610;
    ...
    private void jButton106ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton106ActionPerformed
          ...
          if(jComboBox2.getSelectedItem().toString().equalsIgnoreCase("Select Portfolio Owner")){JOptionPane.showMessageDialog(this, "Please First Select The Portfolio Owner");return;}else{
        if(writeExcel.createSheet2TheBook( otherLoans.createExceleAgingReport(), "Aging", "aging_report")){
        
       generateFileExcel("aging_report");
...
//             
 ...
 int today=cal.get(GregorianCalendar.YEAR)+cal.get(GregorianCalendar.MONTH);
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        fios.stringFileWriter(fios.createFileName("PMMS_Statements", "reports", "portfolioOwner.txt"),jComboBox2.getSelectedItem().toString().split("\\s+")[2].trim());
...
amountFieldDebit2.setValue(null);
    ...
    private void jButton115ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton115ActionPerformed
         ...
         return;
               ...
               if(sheet.createBalanceSheet(fmt.forDatabaseWithFullYearBeginningWithDate(valueDate8.getText()),"balanceSheet")){
         ...
         theOtheProfitAndLoss.add(valueDate9.getText().trim());  
          ...
          ProfitAndLossNew finPosPnL=new ProfitAndLossNew(theOtheProfitAndLoss);
            JOptionPane.showMessageDialog(this, "Wait!!! Wait!!....P&L is beeing created!!!");
                ...
                @Override
                protected ListDataModel doInBackground() throws Exception {
                return  finPosPnL.createProfitAndLoss();
                }
...
//            jButton116.setEnabled(false);
        ...
        return;
         ...
         theBudgetReport.add(jTextField23.getText().trim());  
          ...
          BudgetVarianceAnalysisReport budget=new BudgetVarianceAnalysisReport(theBudgetReport);
                ...
                @Override
                protected ListDataModel doInBackground() throws Exception {
                return  budget.createBudgetVarianceAnalysis();
                }
    ...
    private void jButton125ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton125ActionPerformed
        ...
        if(jComboBox2.getSelectedItem().toString().equalsIgnoreCase("Select Portfolio Owner")){JOptionPane.showMessageDialog(this, "Please First Select The Portfolio Owner");return;}else{
            ...
            if(otherLoans.createAgingReport("aging_report")){
        
       generateFile("aging_report");
    ...
    private void jButton128ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton128ActionPerformed
     List loanListing= new ArrayList();
        
      
        
          
            JOptionPane.showMessageDialog(this, "Wait while loan listing report is beeing created!!!");
                SwingWorker<ListDataModel,Void>projectedWorker=new SwingWorker() {
                @Override
                protected ListDataModel doInBackground() throws Exception {
                return  otherLoans.loanListings();
                }
                ...
                loanListing.add(result);
                
         ReportView f1 = new ReportView(userId,"loanListings",loanListing);
        f1.setVisible(true);
        Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
        f1.setSize(screen.getSize());
        f1.pack();
...
//        List quickSummuryList= new ArrayList();
//
//            JOptionPane.showMessageDialog(this, "Wait while Quick Summury report is beeing created!!!");
//                SwingWorker<ListDataModel,Void>projectedWorker=new SwingWorker() {
//                @Override
//                protected ListDataModel doInBackground() throws Exception {
//                return  otherLoans.quickSummuryReport();
//                }
//
//                @Override
//                protected void done() {
...
//                Logger.getLogger(Reportx.class.getName()).log(Level.SEVERE, null, ex);
//                }
//                quickSummuryList.add(result);
//                
//         ReportView f1 = new ReportView(userId,"quickSummury",quickSummuryList);
//        f1.setVisible(true);
//        Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
//        f1.setSize(screen.getSize());
//        f1.pack();
...
//            jButton116.setEnabled(false);
   ...
   sharesDetails1.add(jTextField67.getText().trim());  
            ...
            JOptionPane.showMessageDialog(this, "Wait!!! Wait!!....The return on investment on Savings  is beeing created!!!");
                ...
                @Override
                protected ListDataModel doInBackground() throws Exception {
                return  otherLoans.returnOnInvestmentSavings(sharesDetails1,c);
                }
...
//            JOption
     ...
     if(otherLoans.groupReturnSavingsDaily(fmt.forDatabaseWithFullYearBeginningWithDate(jTextField68.getText().trim()),fmt.forDatabaseWithFullYearBeginningWithDate(jTextField67 .getText().trim()),"ROI_Group_Savings",this)){
...
return thecounter;
 ...
 summuryReportDetails=new ArrayList();
  ...
  this.summuryReportDetails.remove(newDetails);
    ...
    private javax.swing.JPanel agingReport;
    ...
    private javax.swing.JPanel performingLoanPortfolio;
