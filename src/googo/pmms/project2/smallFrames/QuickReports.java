...
//        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        switch(theRepoType){
                ...
                case "CASH A/C":
                    debitAccountField1.setValue(fmt.putSeparatorsOnNormaAccount("01123000110"));
...
this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     if(pAndL.createPAndL(fmt.forDatabaseWithFullYearBeginningWithDate(jTextField60.getText().trim()),fmt.forDatabaseWithFullYearBeginningWithDate(jTextField59.getText().trim()),"pAndL")){
